...
_changeproc:     file format elf32-i386
...
int main(int argc,char *argv[]) //  1:for Ticket  2:for FCFS  3:for priority
{
  ...
  if(argc!=3 && argc!=4){
  18:	8d 43 fd             	lea    -0x3(%ebx),%eax
  1b:	83 f8 01             	cmp    $0x1,%eax
  1e:	76 14                	jbe    34 <main+0x34>
  ...
  2a:	e8 81 04 00 00       	call   4b0 <printf>
    exit();
  2f:	e8 0e 03 00 00       	call   342 <exit>
  }
  if(atoi(argv[2])!=2 && argc!=4){
  34:	83 ec 0c             	sub    $0xc,%esp
  37:	ff 76 08             	pushl  0x8(%esi)
  3a:	e8 91 02 00 00       	call   2d0 <atoi>
  3f:	83 c4 10             	add    $0x10,%esp
  42:	83 f8 02             	cmp    $0x2,%eax
  45:	74 18                	je     5f <main+0x5f>
  47:	83 fb 04             	cmp    $0x4,%ebx
  4a:	74 13                	je     5f <main+0x5f>
    printf(2,"valid format 2 : changeproc pid queue (priiority or ticketNum)\n");
  4c:	53                   	push   %ebx
  4d:	53                   	push   %ebx
  4e:	68 10 08 00 00       	push   $0x810
  53:	6a 02                	push   $0x2
  55:	e8 56 04 00 00       	call   4b0 <printf>
    exit();
  5a:	e8 e3 02 00 00       	call   342 <exit>
  }
  if(atoi(argv[2])==1){
  5f:	83 ec 0c             	sub    $0xc,%esp
  62:	ff 76 08             	pushl  0x8(%esi)
  65:	e8 66 02 00 00       	call   2d0 <atoi>
  ...
  75:	ff 76 08             	pushl  0x8(%esi)
  78:	e8 53 02 00 00       	call   2d0 <atoi>
  7d:	83 c4 10             	add    $0x10,%esp
  80:	83 f8 02             	cmp    $0x2,%eax
  83:	74 3c                	je     c1 <main+0xc1>
    addToFCFS(atoi(argv[1]));
    exit();
  }
  else if(atoi(argv[2])==3){
  85:	83 ec 0c             	sub    $0xc,%esp
  88:	ff 76 08             	pushl  0x8(%esi)
  8b:	e8 40 02 00 00       	call   2d0 <atoi>
  90:	83 c4 10             	add    $0x10,%esp
  93:	83 f8 03             	cmp    $0x3,%eax
  96:	74 41                	je     d9 <main+0xd9>
    addToPriority(atoi(argv[1]), atoi(argv[3]));
    exit();
  }
  else{
    exit();
  98:	e8 a5 02 00 00       	call   342 <exit>
  if(atoi(argv[2])!=2 && argc!=4){
    printf(2,"valid format 2 : changeproc pid queue (priiority or ticketNum)\n");
    exit();
  }
  ...
  a0:	ff 76 0c             	pushl  0xc(%esi)
  a3:	e8 28 02 00 00       	call   2d0 <atoi>
  a8:	89 c3                	mov    %eax,%ebx
  aa:	58                   	pop    %eax
  ab:	ff 76 04             	pushl  0x4(%esi)
  ae:	e8 1d 02 00 00       	call   2d0 <atoi>
  b3:	5a                   	pop    %edx
  b4:	59                   	pop    %ecx
  b5:	53                   	push   %ebx
  b6:	50                   	push   %eax
  b7:	e8 26 03 00 00       	call   3e2 <addToTicket>
    exit();
  bc:	e8 81 02 00 00       	call   342 <exit>
  }
  else if(atoi(argv[2])==2){
    addToFCFS(atoi(argv[1]));
  c1:	83 ec 0c             	sub    $0xc,%esp
  c4:	ff 76 04             	pushl  0x4(%esi)
  c7:	e8 04 02 00 00       	call   2d0 <atoi>
  cc:	89 04 24             	mov    %eax,(%esp)
  cf:	e8 16 03 00 00       	call   3ea <addToFCFS>
    exit();
  d4:	e8 69 02 00 00       	call   342 <exit>
  }
  else if(atoi(argv[2])==3){
    addToPriority(atoi(argv[1]), atoi(argv[3]));
  d9:	83 ec 0c             	sub    $0xc,%esp
  dc:	ff 76 0c             	pushl  0xc(%esi)
  df:	e8 ec 01 00 00       	call   2d0 <atoi>
  e4:	89 c3                	mov    %eax,%ebx
  e6:	58                   	pop    %eax
  e7:	ff 76 04             	pushl  0x4(%esi)
  ea:	e8 e1 01 00 00       	call   2d0 <atoi>
  ef:	5a                   	pop    %edx
  f0:	59                   	pop    %ecx
  f1:	53                   	push   %ebx
  f2:	50                   	push   %eax
  f3:	e8 fa 02 00 00       	call   3f2 <addToPriority>
    exit();
...
000003f2 <addToPriority>:
SYSCALL(addToPriority)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44f:	f7 f6                	div    %esi
 451:	0f b6 92 58 08 00 00 	movzbl 0x858(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5c8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5cb:	b8 50 08 00 00       	mov    $0x850,%eax
...
free(void *ap)
{
 ...
 6a7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6a9:	a3 f8 0a 00 00       	mov    %eax,0xaf8
}
 6ae:	5b                   	pop    %ebx
 6af:	5e                   	pop    %esi
 6b0:	5f                   	pop    %edi
 ...
 6ca:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6cd:	a3 f8 0a 00 00       	mov    %eax,0xaf8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 78c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 78f:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
      return (void*)(p + 1);
 ...
 7a4:	eb e9                	jmp    78f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 05 f8 0a 00 00 fc 	movl   $0xafc,0xaf8
 7ad:	0a 00 00 
 7b0:	c7 05 fc 0a 00 00 fc 	movl   $0xafc,0xafc
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	b8 fc 0a 00 00       	mov    $0xafc,%eax
 7bf:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 7c6:	00 00 00 
